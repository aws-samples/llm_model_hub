    ...
    resources: {
      en: {
        translation: {
            ...
            initial_instance_qty:"Initial Instance Quantity",
            initial_instance_qty_desc:"Initial Number of SageMaker Endpoint Instances",
            max_instance_qty:"Max Scale-Out Instance Quantity",
            max_instance_qty_desc:"Max Number of SageMaker Endpoint Scale-Out Instance Quantity",
            min_instance_qty:"Minimum Scale-In Instance Quantity",
            min_instance_qty_desc:"Minimum Number of SageMaker Endpoint Scale-In Instance Quantity (>=0)",
            enable:'Enable',
            refresh:"Refresh",
            ...
            deploy:'Deploy',
            deploy_endpoint:"Deploy model as endpoint",
            ...
            scalingheader:'Auto Scaling Policy',
            custom_endpoint_name:"(Optional) Customize Endpoint Name",
            custom_model_repo:'Customize Repo',
            custom_model_repo_s3:'Model files from S3Path',
            target_tps:'Target TPS Value',
            target_tps_desc:'If request per second exceeds the target, it starts scaling out',
            scalein_cooldown:'Scale-In Cooldown (second)',
            scaleout_cooldown:'Scale-Out Cooldown (second)',
            scalein_cooldown_desc:'The time to wait before another scale-in activity can be performed',
            scaleout_cooldown_desc:'The time to wait before another scale-out activity can be performed',
        }
      },
      zh:{
        translation:{
            ...
            initial_instance_qty:"初始实例数量",
            initial_instance_qty_desc:"推理节点的初始实例数量",
            max_instance_qty:"最大扩容实例数量",
            max_instance_qty_desc:"推理节点的最大扩容实例数量",
            min_instance_qty:"最小缩容实例数量",
            min_instance_qty_desc:"推理节点的最小缩容实例数量(最小0)",
            enable:'启用',
            refresh:'刷新',
            use_spot:"使用Spot实例",
            ...
            viewcode:'调用代码',
            scalingheader:'自动扩缩容策略',
            deploy_endpoint:"部署推理节点",
            custom_endpoint_name:"(选填)自定义Endpoint Name",
            custom_model_repo:'自定义模型仓库',
            custom_model_repo_s3:'自定义模型S3Path',
            target_tps:'目标TPS',
            target_tps_desc:'超过目标TPS将开始阶梯扩容',
            scalein_cooldown:'缩容冷却时间(秒)',
            scaleout_cooldown:'扩容冷却时间(秒)',
            scalein_cooldown_desc:'在执行下一次缩减活动之前需要等待的时间',
            scaleout_cooldown_desc:'在执行下一次扩容活动之前需要等待的时间',
        }
      }
    }
  });
